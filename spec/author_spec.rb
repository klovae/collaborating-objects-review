describe Author do
  ...
  context 'has many stories' do
    ...
    describe '#build_story' do
      it "creates a story instance from a name and adds that story to an author's stories" do
        author.build_story("A Farewell to Arms")

        expect(author.bibliography).to include("A Farewell to Arms")
      end
    end
